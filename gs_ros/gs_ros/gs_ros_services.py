...
class Gs_Ros_Services:
    def __init__(self,scene,ros_node,robots,objects,all_cameras):
        self.scene=scene
    ...
    def setup_set_entity_pose_service(self):
        ...
        self.set_entity_pose_service=self.ros_node.create_service(SetEntityPose,f"{self.ns}/set_entity_pose",set_entity_pose_service_callback)
    ...
    def setup_ik(self):
        self.ik_service=self.ros_node.create_service(IKTarget,f"{self.ns}/inverse_kinematics_target",self.ik_service_callback)
    ...
    def setup_fk(self):
        self.fk_service=self.ros_node.create_service(FKTarget,f"{self.ns}/forward_kinematics_target",self.fk_service_callback)
    ...
    def setup_path_plan(self):
        self.path_plan_service=self.ros_node.create_service(PathPlanTarget,f"{self.ns}/path_plan_target",self.plan_path_callback)
    ...
    def setup_suction_cup_switch_service(self):
        self.suction_cup_switch=self.ros_node.create_service(SuctionSwitch,f"{self.ns}/set_suction_state",self.suction_cup_switch_callback)
    ...
    def setup_join_entities_service(self):
        self.join_entities_service=self.ros_node.create_service(JoinEntities,f"{self.ns}/join_entities",self.join_entities_callback)

    # def modify_camera_callback(self,request_response):
    #     cam_name=
            
    # def setup_modify_camera_service(self):
    #     self.modify_camera_service=self.ros_node.create_service(ModifyCamera,f"{self.ns}/modify_camera",self.modify_camera_callback)
    ...
    def start_recording_callback(self,request,response):
        ...
        if cam._inrecording:
            response.success=False
            response.message="Camera alreday recording"
            return response    
        cam.start_recording()
        response.sucess=True
    ...
    def setup_start_recording_service(self):
        self.start_recording_service=self.ros_node.create_service(StartRecording,f"{self.ns}/start_recording",self.start_recording_callback)
    ...
    def setup_pause_recording_service(self):
        self.pause_recording_service=self.ros_node.create_service(PauseRecording,f"{self.ns}/pause_recording",self.pause_recording_callback)
    ...
    def setup_stop_recording_service(self):
        self.stop_recording_service=self.ros_node.create_service(StopRecording,f"{self.ns}/start_recording",self.stop_recording_callback)
    ...
    #     self.joint_visualisation_service=self.ros_node.create_service(VisualiseJointStates,f"{self.ns}/visualise_joint_states",self.joint_visualisation_callback)
    ...
    def setup_set_dofs_physics_attr_service(self):
        self.set_dofs_physics_attr_service=self.ros_node.create_service(SetPhysicsAttributes,f"{self.ns}/set_dofs_physics_attribute",self.set_dofs_physics_attr_callback)
    ...
    def setup_set_links_physics_attr_service(self):
        self.set_links_physics_attr_service=self.ros_node.create_service(SetPhysicsAttributes,f"{self.ns}/set_links_physics_attribute",self.set_links_physics_attr_callback)
    ...
    def setup_reset_simulator_service(self):
        self.reset_simulator_service=self.ros_node.create_service(SetBool,f"{self.ns}/RESET_SIMULATOR",self.reset_simulator_callback)
